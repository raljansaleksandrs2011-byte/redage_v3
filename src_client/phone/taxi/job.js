...
gm.events.add(clientName + "add", (id, name, posX, posY, posZ) => {
    ...
    mp.gui.chat.push(translateText("!{#00a86b}[DISPATCHER: !{#ffffff}Player {0} called a taxi !{#ffcc00}({1}m)!{#ffffff}. Open your phone to accept the call", name, newItem.dist));
    mp.events.call('phone.notify', 228, translateText("A new order has appeared! :)"), 4);
});
